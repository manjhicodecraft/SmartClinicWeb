        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {areas.map((area, i) => (
            <motion.div
              ...
              className="group relative overflow-hidden rounded-2xl aspect-[3/4] cursor-pointer shadow-xl"
            >
              {/* Always-dark gradient background so text stays readable regardless of theme */}
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center">
                <span className="text-6xl mb-4 group-hover:scale-125 transition-transform duration-300">{icons[i]}</span>
              </div>
