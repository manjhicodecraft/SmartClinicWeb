  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center pt-20 overflow-hidden bg-slate-950">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-1/3 right-1/4 w-96 h-96 bg-accent/20 rounded-full mix-blend-screen filter blur-3xl opacity-30 animate-blob animation-delay-2000"></div>
        <div className="absolute bottom-1/4 left-1/2 w-96 h-96 bg-primary/20 rounded-full mix-blend-screen filter blur-3xl opacity-30 animate-blob animation-delay-4000"></div>
      </div>
      ...
      <div className="container relative z-10 mx-auto px-4 md:px-6 grid lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Button size="lg" className="rounded-full text-base h-14 px-8 gap-2 bg-primary hover:bg-primary/90 text-primary-foreground" onClick={onBookClick}>
              <Calendar className="w-5 h-5" />
              Book Appointment
            </Button>
            <Button size="lg" variant="outline" className="rounded-full text-base h-14 px-8 gap-2 glass text-white hover:bg-white/10" onClick={() => window.location.href = "tel:+919999999999"}>
        ...
        >
          ...
          >
            ...
            <div>
              ...
              <div className="text-sm text-slate-300">Patient Rating</div>
            </div>
          </motion.div>
          ...
          >
            ...
            <div>
              ...
              <div className="text-sm text-slate-300">Patients Treated</div>
            </div>
          </motion.div>
        </motion.div>
      </div>
